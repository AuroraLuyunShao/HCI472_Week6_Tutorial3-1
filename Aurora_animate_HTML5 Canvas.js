...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance}]}).to({state:[{t:this.instance_1}]},7).to({state:[{t:this.instance_2}]},7).to({state:[{t:this.instance_3}]},5).to({state:[{t:this.instance_4}]},4).to({state:[{t:this.instance_5}]},3).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_7}]},1).to({state:[{t:this.instance_8}]},1).wait(1));
	this.timeline.addTween(cjs.Tween.get(this.instance).to({_off:true},7).wait(23));
	this.timeline.addTween(cjs.Tween.get(this.instance_1).to({_off:false},7).to({_off:true},7).wait(16));
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(7).to({_off:false},7).to({_off:true},5).wait(11));
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(14).to({_off:false},5).to({_off:true},4).wait(7));
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(19).to({_off:false},4).to({_off:true},3).wait(4));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-51.8,-8.2,198.2,341.7);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(1005,379.5,1,1,0,0,0,45,165);

	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("rgba(115,58,33,0)").ss(1,1,1).p("AnB5xIODAAMAAAAzjIuDAAg");
	this.shape.setTransform(1005,379.5);
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.shape,p:{x:1005,y:379.5}},{t:this.instance,p:{x:1005,startPosition:0,y:379.5}}]},55).to({state:[{t:this.shape,p:{x:1085,y:379.5}},{t:this.instance,p:{x:1085,startPosition:7,y:379.5}}]},7).to({state:[{t:this.shape,p:{x:1085,y:379.5}},{t:this.instance,p:{x:916,startPosition:14,y:377.5}}]},7).to({state:[{t:this.shape,p:{x:1085,y:379.5}},{t:this.instance,p:{x:1085,startPosition:19,y:379.5}}]},5).to({state:[{t:this.shape,p:{x:920,y:377}},{t:this.instance,p:{x:920,startPosition:23,y:377}}]},4).to({state:[{t:this.shape,p:{x:1085,y:379.5}},{t:this.instance,p:{x:1085,startPosition:26,y:379.5}}]},3).to({state:[{t:this.shape,p:{x:915,y:379.5}},{t:this.instance,p:{x:915,startPosition:27,y:379.5}}]},1).to({state:[{t:this.instance,p:{x:1085,startPosition:28,y:379.5}},{t:this.shape,p:{x:1085,y:379.5}}]},1).to({state:[{t:this.shape,p:{x:1010,y:379}},{t:this.instance,p:{x:1010,startPosition:29,y:379}}]},1).wait(2));

	// Anticipation
	this.instance_1 = new lib.补间6("synched",0);
	this.instance_1.setTransform(630,472.95,0.9722,1);
	this.instance_1._off = true;
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_2}]},1).to({state:[{t:this.instance_3}]},8).to({state:[{t:this.instance_4}]},3).to({state:[{t:this.instance_5}]},3).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_7,p:{scaleX:1,scaleY:0.8743,y:481.95}}]},1).to({state:[{t:this.instance_7,p:{scaleX:0.9162,scaleY:1,y:450}}]},1).to({state:[{t:this.instance_7,p:{scaleX:0.9722,scaleY:1,y:473}}]},1).wait(67));
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(1).to({_off:false},0).to({_off:true,regX:0.1,regY:0.1,scaleX:0.9786,scaleY:0.6035,x:260.1,y:501.05},8).wait(77));
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(1).to({_off:false},8).to({_off:true,regX:0,regY:0,scaleX:0.7082,scaleY:1,x:261,y:319.95},3).wait(74));
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(9).to({_off:false},3).to({_off:true,scaleX:1,scaleY:0.7424,x:260,y:490.95},3).wait(71));

	// Stages
	this.instance_8 = new lib.StageOutline("synched",0);
	this.instance_8.setTransform(260.65,320,1,1,0,0,0,140,225);

	this.instance_9 = new lib.StageOutline("synched",0);
	this.instance_9.setTransform(1000.65,319.8,1,1,0,0,0,140,225);

	this.instance_10 = new lib.StageOutline("synched",0);
	this.instance_10.setTransform(628.2,320,1,1,0,0,0,140,225);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_10},{t:this.instance_9},{t:this.instance_8}]}).wait(86));
